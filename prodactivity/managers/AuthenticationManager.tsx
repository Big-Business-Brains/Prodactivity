...
export default class AuthenticationManager {
    ...
    async refreshTokens(refreshToken: string, userId: string): Promise<Result<AuthenticationViewModel>> {
        try {
            let response = await FetchHelper.post(`${this.baseURL}/refresh`, {"refreshToken": refreshToken, "userId": userId}, await KeychainHelper.retrieveToken(TokenType.AccessToken));
